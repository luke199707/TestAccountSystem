<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminCenter.Master" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="TestAccountSystem.UserList" %>
                            ...
                            <div class="form-group" style="margin-bottom: 5px;">
                             ...
                             <div class="form-group" style="margin-bottom: 5px;">
                               ...
                               <div class="form-group" style="margin-bottom: 5px;">
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtRealName" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                        ...
                        <asp:GridView ID="gvTable" runat="server" AutoGenerateColumns="false" AllowSorting="true" class="table table-bordered table-hover" Width="100%" DataKeyNames="ID" OnSorting="gvTable_Sorting" OnRowCommand="gvTable_RowCommand" OnRowDataBound="gvTable_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="账户状态" SortExpression="isUseful">
                                    <ItemTemplate>
                                        <asp:Literal ID="lState" runat="server" Text='<%#Eval("isUseful").ToString()=="True"?"可用":"禁用" %>'></asp:Literal>
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        ...
                                        <%--<a href="javascript:void(0);" onclick="del(<%#Eval("Id") %>);">禁用</a>--%>
