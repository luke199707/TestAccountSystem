<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminCenter.Master" AutoEventWireup="true" CodeBehind="RegistrationDeleForm.aspx.cs" Inherits="TestAccountSystem.AdminPages.RegistrationDeleForm" %>
            ...
            <div class="row no-margin">
                ...
                <asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="RegisterNumber" DataNavigateUrlFormatString="ShowRegisterInfo.aspx?RegisterNumber={0}&type=RegistrationDeleForm" HeaderText="详细信息" Text="详细信息" />
                    
                        <asp:TemplateField HeaderText="操作">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnDelete" runat="server" CommandArgument='<%# Bind("RegisterNumber") %>' OnClientClick="javascript:return confirm('是否删除该项？');" OnClick="btnDelete_Click">删除</asp:LinkButton>
                                <%--<asp:Button ID="btnDelete" runat="server"  class="btn btn-danger btn-xs" CommandArgument='<%# Bind("RegisterNumber") %>' Text="删除" OnClientClick="javascript:return confirm('是否删除该项？');" OnClick="btnDelete_Click"/>--%>
                             </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
