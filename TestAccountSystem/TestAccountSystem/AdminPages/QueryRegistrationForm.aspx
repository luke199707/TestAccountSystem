<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminCenter.Master" AutoEventWireup="true" CodeBehind="QueryRegistrationForm.aspx.cs" Inherits="TestAccountSystem.AdminPages.QueryRegistrationForm" %>
        ...
        <ContentTemplate>
            ...
            <div class="row no-margin">
                ...
                <asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                    class="table table-bordered table-hover" Width="100%" OnSorting="grid_Sorting" OnRowDataBound="grid_RowDataBound" OnRowCommand="grid_RowCommand" ShowHeaderWhenEmpty="True">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="操作" ItemStyle-Width="150">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnSee" runat="server" CommandArgument='<%# Bind("RegisterNumber") %>' OnClick="lbtnSee_Click">详情</asp:LinkButton>
                                <asp:LinkButton Visible="false" ID="lbtnEdit" runat="server" CommandArgument='<%# Bind("RegisterNumber") %>' OnClick="lbtnEdit_Click">编辑</asp:LinkButton>
                                <asp:LinkButton Visible="false" ID="lbtnQueryReason" runat="server" CommandArgument='<%# Bind("RegisterNumber") %>' OnClick="lbtnQueryReason_Click">查看原因</asp:LinkButton>
                                <asp:LinkButton Visible="false" ID="lbtnQuery" runat="server" CommandArgument='<%# Bind("RegisterNumber") %>' OnClick="lbtnQuery_Click">检验进度</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
