<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminCenter.Master" AutoEventWireup="true" CodeBehind="InspectProjectManagementForm.aspx.cs" Inherits="TestAccountSystem.AdminPages.InspectProjectManagementForm" %>
        ...
        <ContentTemplate>
            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <div class="row form-horizontal" style="margin-bottom: 5px;">
                        <div class="col-xs-2 text-right">
                            <label class="control-label" for="txtProjectNumber">检验项目代码：</label>
                        </div>
                        <div class="col-xs-4" style="padding-left: 0px;">
                            <asp:TextBox ID="txtProjectNumber" runat="server" class="form-control input-sm"></asp:TextBox>
                        </div>
                        <div class="col-xs-2 text-right">
                            <label class="control-label" for="txtProjectName">检验项目名称：</label>
                        </div>
                        <div class="col-xs-4" style="padding-left: 0px;">
                            <asp:TextBox ID="txtProjectName" runat="server" class="form-control input-sm"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row form-horizontal" style="margin-bottom: 5px;">
                        <div class="col-xs-2 text-right">
                            <label class="control-label" for="txtBillingUnit">计费单位：</label>
                        </div>
                        <div class="col-xs-4" style="padding-left: 0px;">
                            <asp:TextBox ID="txtBillingUnit" runat="server" class="form-control input-sm"></asp:TextBox>
                        </div>
                        <div class="col-xs-2 text-right">
                            <label class="control-label" for="txtBillingPrice">单位价格：</label>
                        </div>
                        <div class="col-xs-4" style="padding-left: 0px;">
                            <asp:TextBox ID="txtBillingPrice" runat="server" class="form-control input-sm"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row form-horizontal" style="margin-bottom: 5px;">
                        <div class="col-xs-2 text-right">
                        ...
                        <div class="col-xs-4 col-xs-offset-4 text-center">
                            <div class="btn-group">
                                ...
                                <asp:Button ID="btnUpdateCancel" runat="server" Text="取消" OnClick="btnUpdateCancel_Click"
                                    class="btn btn-default btn-sm" />
                                <asp:Button ID="btnDel" runat="server" Text="删除" OnClick="btnDel_Click" OnClientClick="javascript:return confirm('是否删除该项？');"
                                    class="btn btn-default btn-sm" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row no-margin">
                        ...
                        <asp:GridView ID="grid" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                            ...
                            OnRowDataBound="GridViewDepart_RowDataBound" Width="100%" OnSorting="grid_Sorting">
