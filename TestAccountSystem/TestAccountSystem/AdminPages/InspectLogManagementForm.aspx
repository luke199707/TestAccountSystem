<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminCenter.Master" AutoEventWireup="true" CodeBehind="InspectLogManagementForm.aspx.cs" Inherits="TestAccountSystem.AdminPages.InspectLogManagementForm" %>
                    ...
                    <div class="col-xs-12">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="序号" SortExpression="ID">
                                        <ItemTemplate>
                                            ...
                                            <asp:Literal ID="LiteralCode" runat="server" Text='<%#Eval("LogNumber") %>' Visible="false"></asp:Literal>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        <div class="row form-horizontal" style="margin-bottom: 5px;">
                            ...
                            <div class="col-xs-7" style="padding-left: 0px;">
                                <asp:TextBox ID="txtLogNumber" runat="server" class="form-control input-sm"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row form-horizontal" style="margin-bottom: 5px;">
                            <div class="col-xs-3 text-right">
                        ...
                        <div class="row form-horizontal" style="margin-bottom: 5px;">
                            ...
                            <div class="col-xs-7 text-left" style="padding-left: 0px;">
                                <asp:TextBox ID="txtInspector" runat="server" class="form-control input-sm"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row form-horizontal" style="margin-bottom: 5px;">
                            <div class="col-xs-3 text-right">
