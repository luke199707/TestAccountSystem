<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminCenter.Master" AutoEventWireup="true" CodeBehind="RegistrationEditForm.aspx.cs" Inherits="TestAccountSystem.AdminPages.RegistrationEditForm" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 has-error txtDiv">
                        <asp:TextBox ID="txtOrderDate" runat="server" CssClass="form-control" onClick="WdatePicker()" ></asp:TextBox>
                    </div>
                </div>
                <br />
                <div class="row">
                ...
                <%--<div class="row">
                    ...
                    <div class="col-sm-3 has-error">
                        <asp:TextBox ID="txtRegisterNumber" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                    </div>
                    <div class="col-sm-1">
                        <asp:Label ID="Label3" runat="server" Text="*船舶登记号：" class="text-danger" for="txtShipRegisterNumber"></asp:Label>
                    </div>
                    <div class="col-sm-3 has-error">
                        <asp:TextBox ID="txtShipRegisterNumber" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                    </div>
                    <div class="col-sm-1">
                        <asp:Label ID="Label15" runat="server" Text="检验名称：" class="" for="txtInspectionName"></asp:Label>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-1">
                        <asp:Label ID="Label8" runat="server" Text="*开户银号及账号：" class="text-danger" for="txtBankAccount"></asp:Label>
                    </div>
                    <div class="col-sm-3 has-error">
                        <asp:TextBox ID="txtBankAccount" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-1">
                        <asp:Label ID="Label43" runat="server" Text="冷藏总容积（m^3）：" class="" for="txtTotalRefrigeratedVolume"></asp:Label>
                    </div>
                    <div class="col-sm-3">
                        <asp:TextBox ID="txtTotalRefrigeratedVolume" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-1">
                        <asp:Label ID="Label46" runat="server" Text="压载舱容（m^3）：" class="" for="txtBallastTankCapacity"></asp:Label>
                    </div>
                    <div class="col-sm-3">
                        <asp:TextBox ID="txtBallastTankCapacity" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-1">
                        <asp:Label ID="Label49" runat="server" Text="液化气舱总容积（m^3）：" class="" for="txtTotalVolumeOfLiquefiedGasTank"></asp:Label>
                    </div>
                    <div class="col-sm-3">
                        <asp:TextBox ID="txtTotalVolumeOfLiquefiedGasTank" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
        ...
        <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <asp:Button ID="btnSubmit" runat="server" Text="提交" class="btn btn-success btn-lg btn-block" OnClick="btnSubmit_Click" />
                    </div>
                    <div class="col-sm-6">
