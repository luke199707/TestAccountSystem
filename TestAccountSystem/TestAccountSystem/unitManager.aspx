<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminCenter.Master" AutoEventWireup="true" CodeBehind="unitManager.aspx.cs" Inherits="TestAccountSystem.unitManager" %>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12 form-horizontal">
                            ...
                            <div class="form-group" style="margin-bottom: 5px;">
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtAddress" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group" style="margin-bottom: 5px;">
                                <div class="col-xs-2 text-right" style="width: 120px; height: 32px">
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtFBank" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-xs-2 text-right">
                                    <label class="control-label" for="txtWeightUnit">
                                        银行账号：</label>
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtbankAccount2" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group" style="margin-bottom: 5px;">
                                <div class="col-xs-2 text-right" style="width: 120px; height: 32px">
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtFax" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-xs-2 text-right">
                                    <label class="control-label" for="txtWeightUnit">
                                        邮箱：</label>
