<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminCenter.Master" AutoEventWireup="true" CodeBehind="CustomerManager.aspx.cs" Inherits="TestAccountSystem.CustomerManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12 form-horizontal">
                            ...
                            <div class="form-group" style="margin-bottom: 5px;">
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtCompanyId" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-xs-2 text-right">
                                    <label class="control-label" for="txtWeightUnit">
                                        公司名称：</label>
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtCompanyName" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group" style="margin-bottom: 5px;">
                                <div class="col-xs-2 text-right" style="width: 120px; height: 32px">
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtCompanyAddress" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-xs-2 text-right">
                                    <label class="control-label" for="txtWeightUnit">
                                        开户银行：</label>
                            ...
                            <div class="form-group" style="margin-bottom: 5px;">
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtBankAccount" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-xs-2 text-right">
                                    <label class="control-label" for="txtWeightUnit">
                                        公司法人：</label>
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtPerson" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group" style="margin-bottom: 5px;">
                                <div class="col-xs-2 text-right" style="width: 120px; height: 32px">
                                ...
                                <div class="col-xs-4" style="padding-left: 0px;">
                                    <asp:TextBox ID="txtPhone" class=" form-control input-sm" runat="server"></asp:TextBox>
                                </div>
                        ...
                        <asp:GridView ID="gvTable" runat="server" AutoGenerateColumns="false" AllowSorting="true" class="table table-bordered table-hover" Width="100%" DataKeyNames="ID" OnSorting="gvTable_Sorting" OnRowCommand="gvTable_RowCommand" OnRowDataBound="gvTable_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="客户名" SortExpression="userName">
                                    <ItemTemplate>
                                        <%#Eval("userName") %>
                                        <%--  <asp:Literal ID="Literalusername" runat="server" Text='<%#Eval("userName") %>'></asp:Literal>--%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="账户状态" SortExpression="isUseful">
                                    <ItemTemplate>
                                        <asp:Literal ID="lState" runat="server" Text ='<%#GetState(Eval("isUseful").ToString(),Eval("state").ToString()) %>'></asp:Literal>                                                                              
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="LbtnBan" CommandName="btnBan" CommandArgument='<%#Eval("Id") %>' runat="server" Visible="false">禁用</asp:LinkButton>
                                          <asp:LinkButton ID="LbtnAllow" runat="server" CommandName="btnAllow" CommandArgument='<%#Eval("Id") %>' Visible="false">启用</asp:LinkButton>
    ...
    <script type="text/javascript">
        function resetPwd(id) {
            if (confirm("确定要重置此客户的密码吗？")) {
                $.post("handler/customerResetPwd.ashx", { "Id": id }, function (data) {
                    if (data == "ok") {
                        alert('此客户密码重置成功了！');
                    } else {
                        alert('此客户密码重置失败了！');
        ...
        function del(id) {
            if (confirm("确定要删除此条记录吗？")) {
                $.post("handler/customerdel.ashx", { "Id": id }, function (data) {
                    if (data == "ok") {
                        location.href = "CustomerManager.aspx";
                    } else {
                        alert("客户信息删除失败了！");
                    }
                });
