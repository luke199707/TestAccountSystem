<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminCenter.Master" AutoEventWireup="true" CodeBehind="defaultMsg.aspx.cs" Inherits="TestAccountSystem.CustomerPages.defaultMsg" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li><i class="fa fa-home fa-fw home-icon"></i><a href="#">填写公司信息</a> </li>
                    <%-- <li class="active">填写公司信息</li>--%>
                </ul>
            </div>
                    ...
                    <div class="row no-margin">
                        <div class="col-md-12 text-center">
                            <div class="btn-group" style="margin-top: 20px">
                                ...
                                <asp:Button ID="btnCertain" class="btn btn-default btn-sm" runat="server" Text="提交" OnClick="btnCertain_Click" />
