<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminCenter.Master" AutoEventWireup="true" CodeBehind="UserMenuDialog1.aspx.cs" Inherits="TestAccountSystem.UserMenuDialog1" %>
        ...
        <ContentTemplate>
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">
                        <label id="lbRoleName" runat="server">附加权限设置</label>
                    </li>
                </ul>
            </div>
